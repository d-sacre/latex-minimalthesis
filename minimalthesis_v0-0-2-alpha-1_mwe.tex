...
\mtSetupComplete{
	thesis = {
		title = minimalthesis,
		subtitle = {Minimal-Working-Example (v0.0.2-alpha-1)}, % remove if not needed
		type = Dissertation,
		author = {
			name = Max Mustermann,
...
%			affiliation = {University of Beteigeuze, Institute for Experimental Physics, Nanolab},
	...
	pdfmetadata = {
		subject = {A "Minimal Working Example" for the "minimalthesis" LaTeX Documentclass, Version 0.0.2-alpha-1.},
		keywords = {academic-thesis, template, latex, documentclass, minimalthesis, v0.0.2-alpha-1, minimal-working-example}
	},
	titlepage = {
		logo = {
			object type = image,
