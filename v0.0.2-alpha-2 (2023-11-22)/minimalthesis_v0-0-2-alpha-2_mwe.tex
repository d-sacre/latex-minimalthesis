...
\mtSetupComplete{
	thesis = {
		title = minimalthesis,
		subtitle = {Minimal-Working-Example (v0.0.2-alpha-2)}, % remove if not needed
		type = Dissertation,
		author = {
			name = Max Mustermann,
...
%			affiliation = {University of Beteigeuze, Institute for Experimental Physics, Nanolab},
	...
	pdfmetadata = {
		...
		keywords = {academic-thesis, template, latex, documentclass, minimalthesis, v0.0.2-alpha-2, minimal-working-example}
	},
	titlepage = {
		logo = {
			object type = image,
