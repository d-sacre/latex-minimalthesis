\input{./minimalthesis/minimalthesis_preamble.tex}

% bibliography
\addbibresource{./bibliography/example-bibliograhy_biber.bib}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Layout/styling options %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\definecolor{mtColorAccent}{HTML}{00ade9} % define the accent color
\setkomavar{mt::style}{fancy-colorful} % options: plain, fancy-grayscale, fancy-colorful
\setkomavar{mt::font}{sans-serif} % options: serif, sans-serif

% Override for \scshape if font (e.g. sans-serif) does not support it
% delete/comment out if not needed 
\setkomavar{mt::scshape-override}{\bfseries} % default: \bfseries

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Titlepage settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setkomavar{mt::author::name}{John Doe}
\setkomavar{mt::author::place-of-birth}{New York}
\setkomavar{mt::thesis::title}{minimalthesis}

% comment out/delete if not required
\setkomavar{mt::thesis::subtitle}{The Title and a very lengthy Subtitle of the Thesis} 
% comment out/delete if not required
\setkomavar{mt::thesis::titlepage::logo}{%
	\mtLogoTitlepage
} 

\setkomavar{mt::thesis::type}{Type of Thesis (Bachelor/Master/PhD)}
\setkomavar{mt::thesis:legal-type-identifier}{Bachelor (B.Sc.)/Master of Science (M.Sc.)/Philosophical Doctor (PhD)}

% TO BE IMPLEMENTED: Multiple affiliations can be state separated by &, e.g. Example University 1 & Example University 2
% comment out/delete if not needed
\setkomavar{mt::institute}{Example University}
\setkomavar{mt::faculty}{Example Faculty} 
\setkomavar{mt::group}{Example Group} 

\setkomavar{mt::date}{\today} % default: \today

% TO BE IMPLEMENTED: Nicer, more automatic way of inserting the information for the evaluation committee
\setkomavar{mt::examination-committee}{%
	\begin{raggedright}
		\usekomavar*{mt::examination-committee}\\[0.25cm]
		\begin{tabulary}{\linewidth}{ll}
			Chairman: & Prof. Habakuk Tibatong\\
			1. Reviewer: & Prof. H. Bartolomä\\
			2. Reviewer: & Prof. L. Murphy\\
			Additional Examiner: & Prof. S. Boltzmann
		\end{tabulary}
	\end{raggedright}
}
